    ...
    <main onClick={dispatch}>
      {night && (
        <div className="night-sky" aria-hidden="true">
          ...
          <span className="star" style={{ top: '12vh', left: '8vw', animationDelay: '0s' }}>✦</span>
          <span className="star" style={{ top: '22vh', left: '78vw', animationDelay: '1.1s' }}>·</span>
          <span className="star" style={{ top: '8vh', left: '42vw', animationDelay: '0.4s' }}>✧</span>
          <span className="star" style={{ top: '32vh', left: '18vw', animationDelay: '1.8s' }}>·</span>
          <span className="star" style={{ top: '6vh', left: '62vw', animationDelay: '0.7s' }}>✦</span>
          <span className="star" style={{ top: '28vh', left: '88vw', animationDelay: '2.2s' }}>✧</span>
          <span className="star" style={{ top: '18vh', left: '28vw', animationDelay: '1.5s' }}>·</span>
          <span className="star" style={{ top: '14vh', left: '92vw', animationDelay: '0.2s' }}>✦</span>
        </div>
      )}
